...
const createElementPickedByPlayer = () => {
    ...
    pickedElementImg.src = `img/icon-${playerPick}.svg`;
...
const createElementPickedByHouse = () => {
    ...
    const pickedElementImg = document.createElement("img");
    pickedElementImg.src = `img/icon-${housePick}.svg`;
...
const showResult = () => {
    ...
    } else if (winningVariants[state.playerPick].includes(state.housePick)) {
...
const displayShadow = () => {
    if (winningVariants[state.playerPick].includes(state.housePick)) {
